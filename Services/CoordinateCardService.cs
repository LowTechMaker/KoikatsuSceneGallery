...
public class CoordinateCardService : IDisposable
{
    ...
    public Task<List<CoordinateCard>> ScanFoldersAsync(IEnumerable<string> folderPaths)
    {
        return Task.Run(() =>
        {
